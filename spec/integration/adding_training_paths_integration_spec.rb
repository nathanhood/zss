RSpec.describe "Adding training paths" do
  context "valid input" do
    ...
    it "should print a success message" do
      expect(output).to include("Sneaking has been added to the list of
      training paths")
    end
  end
  ...
  context "invalid input" do
    context "really long strings" do
      ...
      it "shouldn't save a new record" do
    ...
    context "numbers" do
      ...
      it "should print an appropriate error message" do
        expect(output).to include("Name must must include letters")
      end
